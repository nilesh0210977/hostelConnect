...
import com.iiitdmk.gdsc.hackathon.Account.SplashActivity;
...
public class DinnerAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setSmallIcon(R.mipmap.logo_hostelconnect);
        builder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.mipmap.logo_hostelconnect));
