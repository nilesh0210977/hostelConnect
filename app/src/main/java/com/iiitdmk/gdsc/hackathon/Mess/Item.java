package com.iiitdmk.gdsc.hackathon.Mess;
...
public class Item {
    ...
    public static ArrayList<Item> makeMenu(int index) {
        ...
        wednesdayMenu.add(new Item(3,"S\nN\nA\nC\nK\nS", "5:00 - 6:00 pm", "" + "Aalo Masala Sandwhich +\n" + "Cheese,\n" + "Ice Tea", null));
