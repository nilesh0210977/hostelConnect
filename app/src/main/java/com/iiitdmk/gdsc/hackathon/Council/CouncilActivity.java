...
import com.iiitdmk.gdsc.hackathon.Utils.CommonFunctions;
...
public class CouncilActivity extends AppCompatActivity
    ...
    private void initCommitteeName() {
        ...
        councilName.add("General Coordinator");
        councilName.add("Sports Coordinator");
        councilName.add("Hostel Guards");
        councilName.add("Mess Coordinator");
        councilName.add("Chief Warden");
        councilName.add("Sports FIC");
        councilName.add("Cultural Coordinator");
    ...
    private void initArrayImage(){
        ...
        councilImage.add(R.drawable.security);
